...
namespace IncidentManagement.Application.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public Comment Comment(int createdBy, int projectId, string text, out string error)
        {
            try
            {
        ...
        public Project Get(int projectId, out string error)
        {
            try
            {
        ...
        public List<Project> GetAll(out string error)
        {
            try
            {
                var projects = _projectRepository.SearchBy(i => i.Active, c => c.CreatedBy, a => a.AssignedTo).Result;
                var result = _mapper.Map<List<Project>>(projects);
                error = "";
                return result;
            }
            catch (System.Exception e)
        ...
        public List<Project> GetCreated(int id, out string error)
        {
            try
            {
        ...
        public List<Project> GetAssigned(int id, out string error)
        {
            try
            {
                var user = _userRepository.FindBy(u => u.Id == id).Result;
        ...
        public bool Update(Project project, out string error)
        {
            try
            {
